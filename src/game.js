...
BasicGame.Game.prototype = {
  ...
  setupBackground: function () {  
    ...
    this.sea.autoScroll(0, BasicGame.SEA_SCROLL_SPEED);
   	this.bg1 = this.add.image(0,-11377.78 + this.game.height, 'bg1');
    this.bg1.width = this.game.width;
    this.bg1.height = 11377.78;
  },  

  setupPlayer: function () {  
    this.player = this.add.sprite(this.game.width / 2, this.game.height - 50, 'plane');
  ...
  setupEnemies: function () { 
    ...
    this.enemyPool.createMultiple(50, 'first_enemy');
    ...
    this.enemyPool.forEach(function(enemy) {
	  ...
	  this.shooterPool.createMultiple(20, 'second_enemy');
	  this.shooterPool.createMultiple(20, 'third_enemy');
...
BasicGame.Stage2.prototype = {
  ...
  setupBackground: function() {
    this.sea = this.add.tileSprite(0, 0, this.game.width, this.game.height, 'sea');
    this.sea.autoScroll(0, BasicGame.SEA_SCROLL_SPEED);
    this.bg2 = this.add.image(0, -11377.78 + this.game.height,  'bg2');
    this.bg2.width = this.game.width;
    this.bg2.height = 11377.78;
  },
  ...
  setupEnemies: function() {
    ...
    this.enemyPool.enableBody = true;
    this.enemyPool.physicsBodyType = Phaser.Physics.ARCADE;
    this.enemyPool.createMultiple(50, 'tpEnemy');
    this.enemyPool.setAll('anchor.x', 0.5);
    this.enemyPool.setAll('anchor.y', 0.5);
    this.enemyPool.setAll('outOfBoundsKill', true);
    this.enemyPool.setAll('checkWorldBounds', true);
    ...
    this.shooterPool.enableBody = true;
    this.shooterPool.physicsBodyType = Phaser.Physics.ARCADE;
    this.shooterPool.createMultiple(20, 'twEnemy');
    this.shooterPool.createMultiple(20, 'tpjEnemy');
    this.shooterPool.setAll('anchor.x', 0.5);
    this.shooterPool.setAll('anchor.y', 0.5);
    this.shooterPool.setAll('outOfBoundsKill', true);
    this.shooterPool.setAll('checkWorldBounds', true);
